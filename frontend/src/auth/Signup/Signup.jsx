...
export default function Login() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex w-full justify-center items-center min-h-[calc(100vh-4rem)] py-5">
        <Card className="md:w-[450px] w-[350px] ">
          <CardHeader className="p-4">
            <CardTitle className="font-bree">Signup</CardTitle>
            <CardDescription>
